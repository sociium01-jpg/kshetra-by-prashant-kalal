...
export function ActionHub() {
  ...
  return (
    <div
      ref={hubRef}
      className={
        "fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3 transition-all duration-400 ease-out " +
        (showHub
          ? "translate-y-0 opacity-100 pointer-events-auto"
          : "translate-y-6 opacity-0 pointer-events-none")
      }
    >
      {/* Expanded Action Sub-Buttons */}
      <div
        className={
      ...
      {/* Main Trigger Button: Liquid Morph & 360 Rim Sheen */}
